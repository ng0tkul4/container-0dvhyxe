...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-0dvhyxe.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-0dvhyxe.containers.anotherwebservice.com/
...
```
git clone git@github.com:ng0tkul4/container-0dvhyxe.git
cd container-0dvhyxe
```
...
```
docker attach container-0dvhyxe
```
